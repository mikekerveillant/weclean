...
export default function Footer() {
  ...
  const commercialWaLink = `https://wa.me/${COMMERCIAL_WHATSAPP}`;
    ...
    <footer className="bg-brand-950 text-brand-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://web.facebook.com/weclean.laundromat"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WeClean on Facebook"
              ...
              <a
                href="https://www.instagram.com/weclean.ph/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WeClean on Instagram"
                className="text-brand-400 hover:text-white transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.linkedin.com/company/weclean-philippines"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WeClean on LinkedIn"
                className="text-brand-400 hover:text-white transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-10 border-t border-brand-800 pt-6 text-center text-xs text-brand-500">
          © {year} WeClean. All rights reserved. ·{' '}
          <Link href="/sitemap.xml" className="hover:text-brand-300 transition-colors">Sitemap</Link>
        </div>
      </div>
    </footer>
  );
